...
************************************************/
LXQtTaskBar2::LXQtTaskBar2(ILXQtPanelPlugin *plugin, QWidget *parent) :
    QFrame(parent),
    ...
    mStyle(new LeftAlignedTextStyle())
{
    ...
    QTimer::singleShot(0, this, &LXQtTaskBar2::settingsChanged);
    setAcceptDrops(true);

    connect(mSignalMapper, &QSignalMapper::mappedInt, this, &LXQtTaskBar2::activateTask);
    QTimer::singleShot(0, this, &LXQtTaskBar2::registerShortcuts);

    mWindowsDriver = initWindowsDriver();

    mDbusAppListener = new DBusAppListener(this);

    //connect(KX11Extras::self(), static_cast<void (KX11Extras::*)(WId, NET::Properties, NET::Properties2)>(&KX11Extras::windowChanged)
    //        , this, &LXQtTaskBar2::onWindowChanged);
    //connect(KX11Extras::self(), &KX11Extras::windowAdded, this, &LXQtTaskBar2::onWindowAdded);
    //connect(KX11Extras::self(), &KX11Extras::windowRemoved, this, &LXQtTaskBar2::onWindowRemoved);
    
    connect(mDbusAppListener, &DBusAppListener::windowOpened, this, &LXQtTaskBar2::onWindowAdded);
    connect(mDbusAppListener, &DBusAppListener::windowClosed, this, &LXQtTaskBar2::onWindowRemoved);

    QTimer::singleShot(2000, this, [this]() {
        // Show all windows
        for(uint window : mDbusAppListener->getWindowList())
 ...
 ************************************************/
bool LXQtTaskBar2::acceptWindow(uint window) const
{
	/*
 ...
 ************************************************/
void LXQtTaskBar2::dragEnterEvent(QDragEnterEvent* event)
{
 ...
 ************************************************/
void LXQtTaskBar2::dragMoveEvent(QDragMoveEvent * event)
{
 ...
 ************************************************/
void LXQtTaskBar2::buttonMove(LXQtTaskGroup * dst, LXQtTaskGroup * src, QPoint const & pos)
{
    int src_index;
 ...
 ************************************************/
void LXQtTaskBar2::groupBecomeEmptySlot()
{
 ...
 ************************************************/
void LXQtTaskBar2::addWindow(uint window)
{
    qDebug() << "[LXQtTaskBar2::addWindow] Adding window " << mDbusAppListener->getWindowAppId(window);
    // If grouping disabled group behaves like regular button
    const QString group_id = mGroupingEnabled ? mDbusAppListener->getWindowAppId(window) : QString::number(window);
    qDebug() << "[LXQtTaskBar2::addWindow] group_id " << group_id;
    ...
    if (!group)
    {
        qDebug() << "[LXQtTaskBar2::addWindow] No group for window " << mDbusAppListener->getWindowAppId(window);
        group = new LXQtTaskGroup(group_id, window, mDbusAppListener, this);
        qDebug() << "[LXQtTaskBar2::addWindow] Group has been built for window " << mDbusAppListener->getWindowAppId(window);
        connect(group, &LXQtTaskGroup::groupBecomeEmpty,  this, &LXQtTaskBar2::groupBecomeEmptySlot);
        connect(group, &LXQtTaskGroup::visibilityChanged, this, &LXQtTaskBar2::refreshPlaceholderVisibility);
        connect(group, &LXQtTaskGroup::popupShown,        this, &LXQtTaskBar2::popupShown);
        ...
        {
            const QString window_class = mDbusAppListener->getWindowAppId(window);
            ...
            for (int i = mLayout->count() - 2; 0 <= i; --i)
            {
                ...
                {
                    const QString current_class = current_group->groupName();
 ...
 ************************************************/
auto LXQtTaskBar2::removeWindow(windowMap_t::iterator pos) -> windowMap_t::iterator
{
 ...
 ************************************************/
void LXQtTaskBar2::refreshTaskList()
{
    QList<WId> new_list;
 ...
 ************************************************/
void LXQtTaskBar2::onWindowChanged(WId window, NET::Properties prop, NET::Properties2 prop2)
{
...
void LXQtTaskBar2::onWindowAdded(uint window)
{
    qDebug() << "[LXQtTaskBar2::onWindowAdded] New window " << window;
 ...
 ************************************************/
void LXQtTaskBar2::onWindowRemoved(WId window)
{
    auto const pos = mKnownWindows.find(window);
 ...
 ************************************************/
void LXQtTaskBar2::refreshButtonRotation()
{
 ...
 ************************************************/
void LXQtTaskBar2::refreshPlaceholderVisibility()
{
 ...
 ************************************************/
void LXQtTaskBar2::setButtonStyle(Qt::ToolButtonStyle buttonStyle)
{
 ...
 ************************************************/
void LXQtTaskBar2::settingsChanged()
{
 ...
 ************************************************/
void LXQtTaskBar2::wheelEvent(QWheelEvent* event)
{
 ...
 ************************************************/
void LXQtTaskBar2::resizeEvent(QResizeEvent* event)
{
    emit refreshIconGeometry();
 ...
 ************************************************/
void LXQtTaskBar2::changeEvent(QEvent* event)
{
 ...
 ************************************************/
void LXQtTaskBar2::registerShortcuts()
{
    ...
    for (int i = 1; i <= 10; ++i)
    {
        ...
        {
            mKeys << gshortcut;
            connect(gshortcut, &GlobalKeyShortcut::Action::registrationFinished, this, &LXQtTaskBar2::shortcutRegistered);
...
void LXQtTaskBar2::shortcutRegistered()
{
    GlobalKeyShortcut::Action * const shortcut = qobject_cast<GlobalKeyShortcut::Action*>(sender());

    disconnect(shortcut, &GlobalKeyShortcut::Action::registrationFinished, this, &LXQtTaskBar2::shortcutRegistered);
...
void LXQtTaskBar2::activateTask(int pos)
{
...
/************************************************
 * Runs properly windows driver. Dbus connection
 * to driver is set by mDbusAppListener
 ************************************************/
QProcess *LXQtTaskBar2::initWindowsDriver()
{
	QString program = QStringLiteral("lxqt_windowlist_wayland_toplevel");
	
	QProcess *process = new QProcess(this);
	process->setProgram(program);
	process->startDetached();
	
	qDebug() << "[LXQtTaskBar2::initWindowsDriver] starting " << program;
